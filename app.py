...
# --- Tabs ---
tab1, tab2, tab3, tab4, tab5, tab6, tab7 = st.tabs(["Overview", "Men vs. Women", "Top 10", "Salary Distribution", "Salary by Municipality", "Salary Change % ", "Summary Stats"])
...
with tab1:
    ...
    # -----------------------------
    # BUILD PLOTLY CHOROPLETH MAPBOX
    # -----------------------------
    fig = px.choropleth_mapbox(
        df_year,
        geojson=geojson,
        locations="Municipality",      # must match GeoJSON feature property
        ...
        zoom=3.8,
        center={"lat": 62.0, "lon": 15.0},  # Center of Sweden
        opacity=0.75,
